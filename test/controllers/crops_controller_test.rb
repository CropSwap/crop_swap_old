...
class CropsControllerTest < ActionController::TestCase
  ...
  test "should create crop" do
    assert_difference('Crop.count') do
      post :create, crop: { crop_type_id: @crop.crop_type_id, description: @crop.description, user_id: @crop.user_id, weight: @crop.weight }
    end
  ...
  test "should update crop" do
    patch :update, id: @crop, crop: { crop_type_id: @crop.crop_type_id, description: @crop.description, user_id: @crop.user_id, weight: @crop.weight }
    assert_redirected_to crop_path(assigns(:crop))
  end
